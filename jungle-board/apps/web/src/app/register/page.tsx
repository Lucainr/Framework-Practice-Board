...
const COHORT_OPTIONS = Array.from({ length: 8 }, (_, index) => 5 + index);
...
export default function RegisterPage() {
  ...
  const isValid = useMemo(() => {
    return (
      ...
      form.studentNumber.trim().length >= 3
    );
  }, [form]);
        ...
        <div className="grid gap-10 p-10 md:grid-cols-[260px,1fr] md:items-start">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="inline-flex items-center justify-center rounded-full bg-emerald-600 px-6 py-3 text-sm font-semibold text-white shadow-lg transition hover:bg-emerald-500 disabled:cursor-not-allowed disabled:bg-emerald-300"
            >
